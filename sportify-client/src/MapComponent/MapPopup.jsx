    ...
    try {
      ...
      if (res.ok) {
        ...
        if (!data.alreadyJoined && onJoinSuccess) {
          onJoinSuccess(item._id, data.attendee);
        }
      } else {
        ...
        <div className="min-w-[200px]">
          ...
          <div className="flex flex-col gap-2 mt-2">
            ...
            <a
              ...
              className="inline-block px-4 py-2 text-sm text-white hover:bg-blue-700 font-bold rounded-md shadow-md hover:shadow-lg transition-all duration-200 text-center"
            >
              Get Directions
            </a>
